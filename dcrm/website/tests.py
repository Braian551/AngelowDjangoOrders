"""Pruebas automatizadas del proyecto AngelowDjangoOrders.

Las pruebas documentan comportamiento esperado: seguridad local, flujo de
login, roles, formularios, mensajes en español y cálculo de totales.
"""
